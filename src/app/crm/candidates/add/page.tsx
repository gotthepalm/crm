...
import { createCandidate } from '@/src/app/crm/candidates/add/createCandidateAction';
			...
			<div className='w-full max-w-[1500px] mx-auto pt-20'>
				<div className='w-full py-12 px-32'>
					<div className='flex w-full justify-between items-center mb-5'>
						<h2 className='text-3xl'>Create Candidate</h2>
					</div>
					<div className='h-[1px] w-full bg-zinc-300 mb-10'></div>
					<form action={action} className='flex flex-col gap-3.5 w-full'>
						<div className='grid grid-cols-[48%_48%] justify-between gap-y-8 mb-5'>
